...
- [ ] 1. Paste your LoginScreen from the exercice 1 Snack into `src/screen/LoginScreen.tsx`
...
- [ ] 3. There is a bug in `src/screen/TOCScreen.tsx`, it can't display all the content. You need to change the View so it has scroll.
